...
1. Download the client library and example tarball. [http://archive.cloudera.com/beta/recordservice/client-dist/recordservice-client-0.3.0-cdh5.5.x-bin.tar.gz](http://archive.cloudera.com/beta/recordservice/client-dist/recordservice-client-0.3.0-cdh5.5.x-bin.tar.gz)
...
<pre>
> hadoop jar /path/to/recordservice-examples-0.3.0-cdh5.5.x.jar \
...
> path/to/spark/bin/spark-shell \
  ...
  --jars /path/to/recordservice-spark-0.3.0-cdh5.5.x.jar
